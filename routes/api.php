...
Route::middleware('auth:sanctum')->get('/all-users', [App\Http\Controllers\TaskController::class, 'users']);
Route::middleware('auth:sanctum')->put('/tasks/{task}/user/{user}',[App\Http\Controllers\TaskController::class, 'updateAssignee']);
Route::middleware('auth:sanctum')->put('/tasks/{task}/phase/{phase}',[App\Http\Controllers\TaskController::class, 'updatePhase']);
Route::middleware('auth:sanctum')->get('/users', [App\Http\Controllers\UserController::class, 'users'])->name('users');
Route::middleware('auth:sanctum')->get('/users/stats', [App\Http\Controllers\UserController::class, 'usersStats'])->name('users.stats');
